...
class FormulariesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create formulary" do
    assert_difference("Formulary.count") do
      post formularies_url, params: { formulary: { name: @formulary.name, visit_id: @formulary.visit_id } }
    end
  ...
  test "should update formulary" do
    patch formulary_url(@formulary), params: { formulary: { name: @formulary.name, visit_id: @formulary.visit_id } }
